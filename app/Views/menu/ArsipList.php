...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">DATA Berkala Pegawai<small class="text-capitalize"> Master Berkala</small></h1>
<!-- end page-header -->
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Data Berkala - Perumdam Tirta Mayang Kota Jambi</h4>
                    ...
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($Berkala as $row) {
                                ...
                                echo "<td>" . $row->Nama . "</td>";
                                echo "<td>" . $row->NoIDKepangkatan . "</td>";
                                echo "<td>" . $row->KenaikanPangkat . "</td>";
                                echo "<td>" . $row->KdGolBaru . " - " . $row->pangkat . "</td>";
                                echo "<td>" . date('Y-m-d', strtotime($row->NoSKBaru)) . "</td>";
                                echo "<td>" . date('Y-m-d', strtotime($row->TglSKBaru)) . "</td>";
                                echo "<td>" . date('Y-m-d', strtotime($row->TMTBaru)) . "</td>";
                                ...
                                echo "<span><a onClick='return confirm(`Apakah anda yakin ingin menghapus data ini ?`)' href='Berkala/delete/" . $row->id . "' type='button' class='btn btn-danger btn-icon btn-sm' title='delete'><i class='fa fa-trash-o fa-lg'></i></a></span> ";
                                echo "</tr>";
                                $no++;
                            }
                            ?>
...
<div id="modaltambah" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" action="Berkala/add" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label">Nomor ID Kepangkatan</label>
                        <input type="text" class="form-control" name="NoIDKepangkatan" value="" required />
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="KdKenaikanPangkat" id="" required>
                            ...
                            foreach ($KenaikanPangkat as $row) {
                                echo "<option value='" . $row->KdKenaikanPangkat . "'>" . $row->KenaikanPangkat . "</option>";
                            }
                            ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="KdGolBaru" id="" required>
                            ...
                            foreach ($Golongan as $row) {
                                echo "<option value='" . $row->kdgol . "'>" . $row->kdgol . " - " . $row->pangkat . "</option>";
                            }
                            ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="NoSKBaru" value="" required />
                    </div>
                    <div class="form-group">
...
<div id="modaledit" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" action="Berkala/edit" method="post" enctype="multipart/form-data">
...
<script>
    ...
    $('#modaledit').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            url: '<?= base_url('Berkala/modaledit') ?>',
            method: 'POST',
            data: {
                'id': id
            },
