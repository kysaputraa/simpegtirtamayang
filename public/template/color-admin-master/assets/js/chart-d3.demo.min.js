...
*/ var blue = "#348fe2",
  ...
  handleLineChart = function () {
    ...
    nv.addGraph(function () {
      for (var e = [], a = [], r = 0; 100 > r; r++)
        e.push({ x: r, y: Math.sin(r / 10) }),
          a.push({ x: r, y: 0.5 * Math.cos(r / 10) });
      var t = [
      ...
      return (
        n.xAxis.axisLabel("Time (s)").tickFormat(d3.format(",.1f")),
  ...
  handleStackedAreaChart = function () {
    ...
    nv.addGraph(function () {
      var a = nv.models
        ...
        .duration(300);
      return (
        a.xAxis.tickFormat(function (e) {
          return d3.time.format("%x")(new Date(e));
        }),
        a.yAxis.tickFormat(d3.format(",.4f")),
        d3
          .select("#nv-stacked-area-chart")
          .append("svg")
          .datum(e)
          .transition()
          .duration(1e3)
    ...
    nv.addGraph({
      generate: function () {
        var a = nv.models.multiBarChart().stacked(!0).showControls(!1),
          r = d3.select("#nv-stacked-bar-chart").append("svg").datum(e);
